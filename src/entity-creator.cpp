...
Entity* EntityCreatorSonic1::create(EntityPlacement entPlacement) {
    ...
    return new Ring(v2f(entPlacement.x, entPlacement.y), artist_, anims, m_entityList, m_terrain);
}
...
Entity* EntityCreatorSonic1::createGeneral(EntityPlacement eplc) {
    ...
    switch ((ObjectID_S1)eplc.objectId) {
        ...
        case (ObjectID_S1::S1_SPRINGS): {
            ...
            return new Spring(position, artist_, anims, !flagYellow, rotation);
        }
        ...
        case (ObjectID_S1::S1_SPIKES): {
            ...
            return new Spikes(position, artist_, anim, eplc.additionalArgs, m_entityList.legacy_rawPool());
        }
        ...
        case (ObjectID_S1::S1_END_OF_LEVEL_SIGNPOST):{
            ...
            auto& animsStick = store_.get<artist_api::Animation>(store_.map<SonicResources>().animations.signPost.stick);
            SignPostAnimations anims = {animsEggman,animsSpin,animsSonic,animsStick};
            return new SignPost(position,artist_,anims);
        }
...
Entity* EntityCreatorSonic1::createEnemies(EntityPlacement eplc) {
    ...
    switch ((ObjectID_S1)eplc.objectId) {
        case (ObjectID_S1::S1_MOTOBUG_ENEMY): {
            ...
            return new EnMotobug(position, artist_, anim, animExplosion, m_terrain);
        }
        ...
        case (ObjectID_S1::S1_CHOPPER): {
            ...
            return new EnChopper(position, artist_, anim, animExplosion);
        }
        ...
        case (ObjectID_S1::S1_CRABMEAT): {
            ...
            return new EnCrab(position, artist_, anim, animExplosion, animBullet, m_entityList.legacy_rawPool(), m_terrain);
        }
        ...
        case (ObjectID_S1::S1_BUZZ_BOMBER):  {
            ...
            return new EnBuzz(position, artist_, anims, animExplosion, animBullet);
        }
        default: 
            return nullptr;
    }
...
Entity* EntityCreatorSonic1::createOther(EntityPlacement eplc) {
    ...
    switch ((ObjectID_S1)eplc.objectId) {
        case (ObjectID_S1::S1_GHZ_BRIDGE):{
            ...
            return new GimGHZ_BridgeController(position, artist_, spr, eplc.additionalArgs, m_entityList.legacy_rawPool());
        }
        ...
        case (ObjectID_S1::S1_PLATFORMS_GHZ_SLZ_SYZ): {
            switch (eplc.additionalArgs & 0x0F) {
                case 0x00:{
                    ...
                    return new GimGHZ_Platform(position, artist_, spr, false, 0);
                }
                case 0x01:{
                    auto& spr = store_.get<artist_api::Sprite>(store_.map<SonicResources>().animations.sprites.greenHillZone.platform);
                    return new GimGHZ_Platform(position, artist_, spr, GimGHZ_Platform::DIR_LEFT, true);
                }
                case 0x02:{
                    auto& spr = store_.get<artist_api::Sprite>(store_.map<SonicResources>().animations.sprites.greenHillZone.platform);
                    return new GimGHZ_Platform(position, artist_, spr, GimGHZ_Platform::DIR_UP, true);
                }
                case 0x03:{
                    auto& spr = store_.get<artist_api::Sprite>(store_.map<SonicResources>().animations.sprites.greenHillZone.platform);
                    return new GimGHZ_Platform(position, artist_, spr, false, 0, true);
                } // Falls when stood on
                //case 0x04: break; // Falls immediately
                case 0x05:{
                    auto& spr = store_.get<artist_api::Sprite>(store_.map<SonicResources>().animations.sprites.greenHillZone.platform);
                    return new GimGHZ_Platform(position, artist_, spr, GimGHZ_Platform::DIR_RIGHT, true);
                }
                case 0x06:{
                    auto& spr = store_.get<artist_api::Sprite>(store_.map<SonicResources>().animations.sprites.greenHillZone.platform);
                    return new GimGHZ_Platform(position, artist_, spr, GimGHZ_Platform::DIR_DOWN, true);
                }
                //case 0x07: break; // x7: Rises when switch in high nybble is pressed
                //case 0x08: break; // x8: Rises immediately
                case 0x09:{
                    auto& spr = store_.get<artist_api::Sprite>(store_.map<SonicResources>().animations.sprites.greenHillZone.platform);
                    return new GimGHZ_Platform(position, artist_, spr, false, false);
                } // x9: Doesn't move
        ...
        case (ObjectID_S1::S1_COLLAPSING_LEDGE_FROM_GHZ):{
            ...
            return new GimGHZ_SlpPlatform(position, artist_, spr, m_entityList.legacy_rawPool(), (bool)eplc.additionalArgs);
        }
        ...
        case (ObjectID_S1::S1_ZONE_SCENERY_OBJECT):{
            ...
            return new GimGhz_BridgeColumn(position, artist_, spr, (bool)eplc.flipHorizontal);
        }
        ...
        case (ObjectID_S1::S1_GHZ_PURPLE_ROCK):{
            ...
            return new GimGHZ_Stone(position,artist_,spr);
        }
        ...
        case (ObjectID_S1::S1_WALL_BARRIER_FROM_GHZ):{
            ...
            switch (eplc.additionalArgs & 0x0F) {
                case 0x0:{
                    ...
                    return new GimGHZ_Wall(position, artist_, spr, eplc.additionalArgs & 0xF0);
                }
                case 0x1:{
